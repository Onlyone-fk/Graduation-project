...
<body>
	...
	<div class="switch" >
		<form name="toform" action="<%= request.getContextPath() %>/itemsController/addstuItems" method="post" >
			<input type="text" id="itemsName" name="itemsName" autocomplete="off" placeholder="丢失物品名" >
			<input type="text" id="sid" name="sid" autocomplete="off" value="${sessionScope.studentID }" placeholder="失主学生编号" readonly>
