...
<body>
			...
			<tbody>
				<c:forEach var="dormitoryList" items="${DormitoryList }">
					<tr>
						...
						<td><a href="<%= request.getContextPath()%>/dormitoryController/queryStuBed?bid=${bid }&did=${ dormitoryList.did }">${ dormitoryList.did }室</a></td>
						<td>
	...
	<a class="back" href="<%= request.getContextPath()%>/StudentView/Building.jsp">返回</a>
</body>
</html>